...
public class Renderer {
    ...
    // System.out.println("$$$$$$$$$$$$$$$$$");
    // System.out
    // .println("VerticesMap: " + parser.getGraph().getVerticesMap());
    ...
    // // place
    // StaticLayout<Node, Edge> layout = new StaticLayout<Node, Edge>(
    ...
    // VertexLookTransformer<Node, Shape> vertexLookTransformer = new
    // VertexLookTransformer<Node, Shape>();
    //
    // // The BasicVisualizationServer<V,E> is parameterized by the edge types
    // BasicVisualizationServer<Node, Edge> visServer = new
    // BasicVisualizationServer<Node, Edge>(
    // layout);
    //
