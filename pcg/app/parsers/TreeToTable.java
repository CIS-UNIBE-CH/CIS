...
public class TreeToTable {
    ...
    /*public TreeToTable(CustomTree tree, int numberOfFactors,
	    int numberOfBundles, int bundleSize) {
	this.tree = tree;
	...
	// DO NOT DELETE NEXT LINE getBundles() Method needs a toString() for
	// initialization.
	tree.toString();
